...
class PseudoQuant4x16MasterFn(Function):
    ...
    def forward(
        ...
        x_flat_dq, x_flat_mask = forward_pseudoquantize(
            x_flat, forward_hadamard_matrix, act_global_scale, dtype, forward_method, outliers
        )

        # Pseudoquantize weights
        weight_dq, weight_mask = forward_pseudoquantize(
            weight, forward_hadamard_matrix, weight_global_scale, dtype, forward_method, outliers
        )
    ...
    def backward(ctx, grad_output: torch.Tensor):
        ...
        return grad_input, grad_weight, None, None, grad_bias, None, None, None, None
...
class PseudoQuant4x16NoMasterFn(Function):
    ...
    def backward(ctx, grad_output: torch.Tensor):
        ...
        return grad_input, None, None, None, grad_bias, None, None, None, None
